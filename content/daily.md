...
## 24/4/2026  
دیشب یه پروژه پیام ناشناس با رمزنگاری پیاما آوردم بالا. تکنیکالی خود سرورای اصلی تلگرام قابلیت دسترسی به همه چیو دارن ولی رو سرور من هیچ پیامی دیده نمیشه برعکس بقیه بات های پیام ناشناس که همه پیامارو یجا ذخیره میکنن و نهایتا به شما این اطمینان و میدن که اوکی ، سرورای ما واقعا امنه ، با این بات مطلقا نیاز به اعتماد به هیچکس ندارید :) یذره دیگه یسری مشکلاتشو برطرف کنم تو گیت هاب میذارم کداشو.
به علاوه اینکه هرکسی میتونه بات لوکال خودشو بیاره بالا و از طریق اون بات باهم ارتباط برقرار کنن :) نیاز به یه بات مرکزی نیست. هه هه هه. 
اسمشو گذاشتم HashChat

اپدیت۲: بنظرم بیت چت همچنان از نظر ایده یه سر و گردن بالاتره. احتمالا بعد از تبلیغ کردن بیت کوین هدف بعدیم پروموت کردن بیت چته بین رفیقام😂 درمورد هش چت اگه سرورشو آوردم بالا یه فایل ساین شده از کد اصلی میذارم ، که از طریق وریفای کردنش با پابلیک کیم مطمئن بشید کدای داخل گیت هاب همونیه که سرور میخونتش. 

## 26/4/2026  
یه حرکت باحالی که زدم ( اما باز باید بیشتر بررسیش بکنم ) اینه که uuid یوزرارو هم هش کردم. یعنی این سری حتی متوجه نمیشیم کی به کی پیام داده‌. :)  
مشکلات درست کردن کلیدم بر طرف کردم هرکسی فقط میتونه یه کلید درست کنه و تا وقتی کلید قبلیشو پاک نکنه نمیتونه کلید جدید بسازه.  
حالا دارم فکر میکنم اینکه تا اینجا رفت... منطقی نیست واقعا یه اپ جدا واسش درست کنیم ؟ 
